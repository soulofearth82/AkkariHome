...
function passdata() {
    var flatno = document.getElementById("flatidd").value;
    var Fulname = document.getElementById("fullnamein").value;
    var idcrd = document.getElementById("Idcard").value;
